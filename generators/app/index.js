...
const { kebabCase, isObject, isString, merge, pick } = require("lodash");
...
module.exports = class extends Generator {
    ...
    async prompting() {
        ...
        const answers = await this.prompt([{
            ...
            when: ({ hasChampion = this.props.hasChampion }) => hasChampion && !this.props.championName,
            default: ({ authorName = this.props.authorName }) => authorName
        }, {
            type: "input",
            name: "championGithub",
            message: "Champion\'s GitHub account",
            when: ({ hasChampion = this.props.hasChampion }) => hasChampion && !this.props.championGithub,
